...
> assets 文件夹：存放项目中用到的静态资源文件，例如：css 样式表、图片资源等。
>
> components 文件夹：程序员封装的、可复用的组件，都放到这里。
>
...
1. template -> 组件的模板结构。（html）
2. script -> 组件的 JavaScript 行为。（js）
3. style -> 组件的样式。（css）
